...
const service = services.find((s) => s.id === 'inspection');
...
export const metadata = {
  title: `Industrial Installation Inspection | ${new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://gle.ae').hostname}`,
  description: safeService.shortDescription,
};

export default function IndustrialInstallationInspectionPage() {
  return (
    <>
      <Header />
      <WhatsAppButton />
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal>
                <p className="text-sm font-semibold uppercase tracking-widest text-technical-teal mb-4">Service 01</p>
              ...
              <ScrollReveal delay={0.2}>
                <div className="aspect-[4/3] bg-gradient-to-br from-deep-navy to-industrial-blue rounded-3xl relative overflow-hidden">
                  <ImageWithFallback
                    src="/images/industrial-installation-inspection.webp"
                    alt=""
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-white/60 text-sm">Industrial Installation Inspection</p>
                    </div>
                  </div>
                </div>
              </ScrollReveal>

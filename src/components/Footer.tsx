    ...
    <footer className="bg-dark text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerNavigation.company.map((item) => (
                <li key={item.href}>
                  <Link href={item.href} className="text-sm text-white/80 hover:text-technical-teal transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-white mb-4">Industries</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/privacy-policy" className="text-sm text-white/70 hover:text-technical-teal transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-sm text-white/70 hover:text-technical-teal transition-colors">
              Terms
            </Link>
          </div>
        </div>

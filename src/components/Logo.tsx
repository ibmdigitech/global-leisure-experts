...
export function Logo({ className = 'h-10 w-auto', logoColor = '#071A2B' }: LogoProps) {
  return (
    <svg viewBox="0 0 200 60" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label={company.name}>
      ...
      <text x="68" y="36" fill={logoColor} className="font-bold text-xl tracking-wider" style={{ fontFamily: 'Manrope, sans-serif' }}>
        {company.shortName}
      </text>
    </svg>
  );
